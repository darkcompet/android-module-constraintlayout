...
package tool.compet.constraintlayout;
...
import tool.compet.graphics.DkDrawable;
import tool.compet.graphics.DkRippleDrawable;
import tool.compet.view.DkViews;

/**
 * This is backward-compatibility version, provides some compatible features:
 * - Foreground: call `setDefaultForeground()` to set default ripple foreground.
 */
public class DkConstraintLayout extends ConstraintLayout {
	...
	public DkConstraintLayout(Context context) {
		super(context);
		init(context);
	}

	public DkConstraintLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
